...
const faqs = [
  {
    ...
    answer: 'Our team provides expert guidance tailored to your business needs.',
  },
  {
    id: '02',
    question: 'We’re here to help you secure what matters most.',
      ...
      <div className="relative z-10 max-w-[1440px] mt-0 md:mt-4 mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_4.5fr]  gap-10 lg:gap-6   items-start">
          ...
          <div className="flex flex-col justify-start">
            ...
            <h3 className="fl3-3 font-bold!">
Get advice any time.
            </h3>

            <p className="fl5-2 text-text-dark mt-3 max-w-[520px]">
              Connect with our team for reliable, expert guidance<br/> whenever you need it.
            </p>
        ...
        <div className="mt-20 md:mt-[100px]">
              ...
              <div className="flex flex-col gap-4">
                {faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    <span className="faq-item-number shrink-0">
                      {faq.id}
                    </span>
                    ...
                    <div className="flex-1 bg-[#F7F7F7] rounded-[37px] px-[20px] lg:px-[27px] py-5 lg:py-8 transition-all group-hover:bg-[#efefef]">
                      <div className="flex justify-between items-center gap-4">
                        ...
                        <Image 
                          src={openIndex === index ? "/images/global/faq-up-icon.svg" : "/images/global/faq-down-icon.svg"} 
                          alt="toggle" 
                          width={24} 
                          height={24} 
                      ...
                      <AnimatePresence>
                          {openIndex === index && (
                              ...
                              >
                                  <p className="faq-item-answer pt-4">
                                      {faq.answer}
                                  </p>
                              </motion.div>
                          )}
          ...
          {/* BOTTOM DECORATIVE LINE (LEFT ALIGNED) */}
          <div className="relative left-0 w-screen pointer-events-none z-0 flex justify-start -ml-6 lg:-ml-12">
