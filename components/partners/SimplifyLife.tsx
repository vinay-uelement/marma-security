...
const features: FeatureItem[] = [
    {
        ...
        description: (
            <>
                <strong className="partners-simplify-strong block mb-2 ">Fully remote deployment and management.</strong>
    ...
    },
    {
        ...
        description: (
            <>
                <strong className="partners-simplify-strong block mb-2 ">Measurable securitperformance in real time.</strong>
                <p className="partners-simplify-desc">
    ...
    },
    {
        ...
        description: (
            <>
                <strong className="partners-simplify-strong block mb-2">Secure remote work from any location.</strong>
                <p className="partners-simplify-desc">
        ...
        <section className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 py-12 md:py-14 bg-[#FFF]">
            ...
            <div className="flex md:flex-row justify-between items-start mb-16 md:mb-24 gap-8 mt-5 md:mt-0">
                <h2 className="partners-simplify-heading mt-8 lg:mt-24">
                    <HighlightedText text="Simplify" className="text-[#323232] font-bold" imageClassName="bottom-[-18px] md:bottom-[-20px] right-[0]" /> Your Life.
                </h2>

                {/* Decorative Red Line Graphic */}
                <div className="flex items-start justify-end w-full max-w-[200px] md:max-w-[400px] lg:max-w-[500px] -mr-6 md:-mr-6 lg:-mr-12 self-end md:self-auto mt-8 md:mt-0">
                    <Image
                        src="/images/home/rightside-section-homepage-new.webp"
                        alt="Decorative Line"   
                        width={500}
                        height={60}
                        className="object-contain w-full h-auto transform -translate-y-12 lg:-translate-y-8"
                    />
                </div>
            </div>
