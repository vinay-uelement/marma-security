      ...
      <section className="hidden lg:block w-full relative py-0 md:py-12 lg:py-16 mb-4 md:mb-0 bg-[#fff]">
        ...
        <div className="absolute top-12 lg:top-16 left-0 w-screen z-20 flex justify-end">
          <div className="w-[180px] md:w-[240px] lg:w-[320px]">
            <DecorativeLine
              viewBox="0 0 500 80"
              points="-3000,40 380,40"
              dots={[{ cx: 380, cy: 40, rippleCount: 3 }]}
        ...
        <div className="w-full max-w-[1440px] mx-auto px-6 pb-3 lg:px-12 relative z-20 mt-6 md:mt-16 lg:mt-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 lg:gap-20 items-end">
            ...
            <div className="flex flex-col space-y-4 relative z-10 pb-6 md-pb-16 pt-8 md:pt-12 lg:pt-0 lg:pb-0 text-center lg:text-left items-center lg:items-start max-w-[600px] mx-auto lg:mx-0">
              {/* Title */}
              <h3 className="fl3">Simplified Network Security</h3>

              {/* Subtitle */}
              <p className="fl4 pb-2">
                Automated protection that scales effortlessly across client
                environments.
              </p>

              {/* Description */}
              <p className="fl4-1 pb-0 text-justify md:text-left !text-text-dark">
                Marma delivers automated, network-level security that is easy to
                deploy, manage, and scale removing complexity while ensuring
                consistent protection for every client With centralized control
                and real-time threat protection, it secures all connected
                devices without added operational effort.
              </p>
      ...
      <section className="lg:hidden w-full relative z-20 flex flex-col pt-10 md:pt-4 pb-5 md:pb-0">
        ...
        <div className="bg-[#F7F7F7] w-full px-6 pt-12 sm:pt-16 pb-2 md:pb-12 relative z-10">
          ...
          <p className="fl4 pb-[15px] text-[#666666]">
            Marma delivers automated, network-level security that is easy to
            deploy, manage, and scale removing complexity while ensuring
            consistent protection for every client With centralized control and
            real-time threat protection, it secures all connected devices
            without added operational effort.
          </p>
          <p className="fl5 mt-4">We think that’s unacceptable.</p>
        </div>
      </section>
    </>
  );
