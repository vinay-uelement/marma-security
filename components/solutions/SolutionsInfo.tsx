  ...
  return (
    <section className="relative w-full pt-12 pb-16 md:pt-10 md:pb-24 flex flex-col items-center overflow-x-clip">
      ...
      <div className="w-full max-w-[1440px] bg-[#f7f7f7] mx-auto px-6 lg:px-12 grid grid-cols-1 py-12 lg:py-20 lg:grid-cols-2 gap-12 lg:gap-16 relative z-10 items-center rounded-sm">
        {/* Image Side */}
        <div
          className={`relative w-full h-[300px] md:h-[400px] lg:h-[420px] rounded-[24px] overflow-hidden ${
        ...
        {/* Content Side */}
        <div
          className={`flex flex-col z-10 relative w-full items-center text-center lg:items-start lg:text-left ${
        ...
        >
          <div className="bg-transparent flex flex-col justify-center items-center lg:items-start relative">
            <h3 className="solutions-info-title pb-[20px] mb-6">{title}</h3>

            <p className="solutions-info-desc mb-20">{description}</p>

            {/* Outlined Explore Button */}
            <button className="relative flex items-center justify-center rounded-full pl-8 pr-12 py-[9px] min-w-[160px] transition-transform hover:scale-[1.02] bg-transparent border border-[#FF000040] text-[#FF0000] hover:bg-[#FF0000]/5 w-fit mt-4 lg:mt-0 group">
