...
export default function SolutionsInfo({
  ...
  return (
    <section className="relative w-full pt-12 pb-0 md:pb-16 md:pt-10 md:pb-24 flex flex-col items-center overflow-x-clip">
      ...
      <div className="w-full absolute top-10 md:top-4 -translate-y-1/2 flex justify-center z-0 select-none pointer-events-none px-0 md:px-4 max-w-[1440px] mx-auto">
