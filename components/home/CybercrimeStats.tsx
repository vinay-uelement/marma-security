...
export default function CybercrimeStats() {
  return (
    <>
      ...
      {/* MOBILE & TABLET VIEW */}
      <section className="lg:hidden w-full relative z-20 flex flex-col pt-0 md:pt-4 -mt-14 bg-transparent">
        {/* Top Half: White bg */}
        <div className="bg-transparent w-full px-6 flex flex-row items-stretch gap-4 relative z-20">
          ...
          <div className="w-[55%] pb-2 text-left flex flex-col  justify-end md:justify-center mt-2">
            <h3 className="fl3 mt-4 sm:mt-6 mr-10 md:mr-0">
              Cybercriminals don’t discriminate small businesses and homes are
              their easiest targets.
            </h3>
          </div>
