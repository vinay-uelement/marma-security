...
export default function SecurityCards() {
    return (
        <section className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 pb-24 bg-[#FFFFFF]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {cards.map((card, index) => (
                    <div key={index} className="flex flex-col h-full relative">
                        ...
                        {/* Card Content block */}
                        <div className="flex flex-col flex-grow bg-[#F9F9F9] p-[24px] md:p-[32px] min-h-[307px]">
