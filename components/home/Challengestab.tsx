    ...
    <section className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 py-4 bg-[#FFFFFF]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-center mb-[60px] gap-8 text-center md:text-left">
        <h2 className="home-challenge-heading">
          Overcoming your{" "}
          <HighlightedText text="challenges" className="font-bold" />
        </h2>
          ...
          {tabItems.map((tab) => {
            ...
            return (
              <button
                ...
                className={`relative pb-4 text-[16px] md:text-[20px] font-body transition-colors leading-[1.3] md:leading-[30px] tracking-[-0.01em] text-left whitespace-normal w-fit max-w-[150px] md:max-w-[200px] ${
                  isActive
