...
export default function ProductPage() {
    return (
        <div className="flex flex-col min-h-screen pt-24 pb-[100px] bg-[#FFFFFF]">
            <main className="flex-grow max-w-[1440px] w-full mx-auto px-6 lg:px-12">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 gap-10 xl:gap-16 pt-12 md:pt-24 items-stretch">
                    ...
                    <div className="flex flex-col justify-between lg:pr-8 mb-12 lg:mb-0 mt-4 lg:mt-14">
                        <h1 className="prod-hero-title text-[#000000] mb-12 lg:mb-16 max-w-[400px]">
                            Security <span className="text-[#FF0000]">Products</span> for<br className="hidden md:block" /> Every Network
                        </h1>
                    ...
                    <div className="bg-[#F1F1F1] rounded-lg p-8 pb-10 flex flex-col items-center relative cursor-pointer">
                        {/* Link Icon */}
                        <div className="absolute top-6 right-6 w-[46px] h-[46px] rounded-full bg-[#6C6C6C] flex items-center justify-center">
                            <Image
                        ...
                        {/* Product Image */}
                        <div className="flex-grow flex items-center justify-center w-full mt-12 mb-8 min-h-[300px]">
                            <Image
                        ...
                        {/* Product Title */}
                        <h3 className="font-body font-semibold text-[32px] leading-[34px] text-[#323232]">
                            SafeHome
                        </h3>
                    </div>
                    ...
                    <div className="bg-[#F1F1F1] rounded-lg p-8 pb-10 flex flex-col items-center relative cursor-pointer">
                        {/* Link Icon */}
                        <div className="absolute top-6 right-6 w-[46px] h-[46px] rounded-full bg-[#6C6C6C] flex items-center justify-center z-10">
                            <Image
                                src="/product-arrow.png"
                                alt="Arrow"
                                width={26}
                        ...
                        {/* Product Image */}
                        <div className="flex-grow flex items-center justify-center w-full mt-12 mb-8 min-h-[300px] z-10">
                            <Image
                                src="/product2biz.png"
                                alt="SafeBiz Device"
                                width={266}
                        ...
                        {/* Product Title */}
                        <h3 className="font-body font-semibold text-[32px] leading-[34px] text-[#323232] z-10">
                            SafeBiz
                        </h3>
                    </div>
